            ...
            assignments: [
              {
                ...
                name: "phone",
                type: "string",
                value: '={{ $json.sender ? $json.sender.replace("@s.whatsapp.net","") : "" }}'
              },
              {
                id: "fromMe",
                name: "fromMe",
                type: "string",
                value: '={{ $json.data && $json.data.key ? String($json.data.key.fromMe) : "unknown" }}'
              },
              {
                id: "text",
                name: "text",
                type: "string",
                value: '={{ $json.data && $json.data.message ? ($json.data.message.conversation || "") : "" }}'
              }
            ]
          },
          options: {}
        ...
        parameters: {
          ...
          bodyParameters: {
            parameters: [
              ...
              { name: "textMessage", value: '={"text":"Hola! Soy ProVitamins Peru. Tenemos proteinas, creatina, pre-entreno y mas. Visita: https://calogojh.duckdns.org"}' }
            ]
          }
        }
      }
