            ...
            assignments: [
              {
                ...
                name: "phone",
                type: "string",
                value: '={{ ($json.data && $json.data.key && $json.data.key.remoteJid) ? $json.data.key.remoteJid.replace("@s.whatsapp.net","") : "" }}'
              },
              {
                id: "fromMe",
                name: "fromMe",
                type: "boolean",
                value: "={{ $json.data && $json.data.key && $json.data.key.fromMe === true }}"
              }
            ]
          },
          options: {}
