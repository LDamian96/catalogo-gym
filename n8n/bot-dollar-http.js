...
// SIMPLEST possible: just return what helpers are available
const debugCode = 'var keys = Object.keys(this); var helpers = typeof this.helpers; return [{json: {thisKeys: keys.join(","), helpersType: helpers, hasHttp: typeof $http, hasFetch: typeof fetch}}];';
...
login(cookie => {
  patch(cookie, "/rest/workflows/botultra", {
    nodes: [
      ...
      {
        id: "c1", name: "Debug", type: "n8n-nodes-base.code", typeVersion: 2,
        position: [500, 300],
        parameters: { jsCode: debugCode }
      }
    ],
    connections: {
      "Webhook": {main: [[{node: "Debug", type: "main", index: 0}]]}
    }
  }, s => {
