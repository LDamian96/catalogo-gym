...
export function ComboDetail({ combo, settings, categories, otherCombos = [] }: ComboDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#000000]">
      ...
      {/* ========= MOBILE Main Content ========= */}
      <div className="lg:hidden max-w-7xl mx-auto relative -mt-6 bg-gradient-to-b from-white to-[#EFF9FF] dark:bg-[#000000] rounded-t-3xl z-10 px-4 pt-4">
        <div className="space-y-5">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button onClick={handleWhatsAppOrder} className="flex-1 h-[46px] bg-[#25D366] text-white font-semibold rounded-full flex items-center justify-center gap-2 shadow-[0_2px_12px_rgba(37,211,102,0.3)] active:scale-[0.98] transition-all duration-200">
