...
export function CombosListing({ combos, settings, categories }: CombosListingProps) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#EFF9FF] via-[#DBEAFE] to-[#E0F2FE] lg:bg-white lg:bg-none dark:bg-[#000000] pb-24 lg:pb-0">
      {/* Desktop Navbar */}
      ...
      <div className="lg:hidden">
        ...
        <section
          className="rounded-b-[26px] shadow-[0_8px_24px_#0EA5E926]"
          style={{ background: 'linear-gradient(130deg, #06B6D4 0%, #0284C7 50%, #1D4ED8 100%)' }}
        >
                      ...
                      <div className="flex items-center justify-between mt-4">
                        <div className="flex items-center gap-2.5">
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full text-[13px] font-bold bg-[#25D366] text-white hover:bg-[#2eda6e] hover:shadow-lg hover:shadow-green-500/25 transition-all"
                          >
